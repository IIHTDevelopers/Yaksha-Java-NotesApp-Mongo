...
import static com.yaksha.assessments.notesservice.utils.TestUtils.exceptionTestFile;
...
import com.yaksha.assessments.notesservice.controller.NoteController;
import com.yaksha.assessments.notesservice.dto.NotesDto;
import com.yaksha.assessments.notesservice.dto.NotesExceptionResponse;
import com.yaksha.assessments.notesservice.exception.NoteIdNotFoundException;
...
public class TestExceptions {
	...
	private NoteService noteService;
		...
		public void testDataValidationCheckIsAddedInController() throws Exception {
			NotesDto notesdto = com.yaksha.assessments.notesservice.utils.MasterData.getNotesDto();
			...
			RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/noteservice/add")
					.content(com.yaksha.assessments.notesservice.utils.MasterData.asJsonString(notesdto))
